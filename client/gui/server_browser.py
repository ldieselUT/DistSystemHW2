...
class Ui_Server_browser(object):
    ...
    def retranslateUi(self, Server_browser):
        ...
        self.groupBox.setTitle(_translate("Server_browser", "Game Controls", None))
        self.attackButton.setText(_translate("Server_browser", "Attack!", None))
        self.PlayerSelectionBox.setTitle(_translate("Server_browser", "Select player to attack", None))
        self.radioButton_2.setText(_translate("Server_browser", "RadioButton", None))
        self.radioButton.setText(_translate("Server_browser", "RadioButton", None))
        self.startGameButton.setText(_translate("Server_browser", "Start Game", None))
